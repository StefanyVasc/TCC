...
\centering
\captionof{table}{Tabela lista os identificadores de 1 a 8 e as diretrizes contempladas}\resizebox{\linewidth}{!}{%
...
\captionof{table}{Tabela exemplificando barreiras e decisões na construção de um gráfico acessível}
